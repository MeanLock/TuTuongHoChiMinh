      ...
      >
        ...
        >
          <h3 className="text-red-800 font-bold text-lg mb-2">
            FROM FPTU HCM202 STUDENTS GROUP
          </h3>
          <h1 className="text-red-900 font-bold text-6xl mb-6">PRESENTING</h1>
          <p className="text-yellow-600 font-medium text-lg max-w-2xl leading-relaxed">
            Khám phá di sản tư tưởng vĩ đại của Chủ tịch Hồ Chí Minh về việc xây
            dựng Đảng Cộng sản và Nhà nước nhân dân - những nền tảng vững chắc
